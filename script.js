const initTerminal = () => {
  ...
  if (!outputEl || !form || !commandInput) {
    console.error("Terminal shell failed to load required elements.");
    return;
  }
  ...
  const commandHandlers = {
    ...
    "play challenge": () => {
      ...
      lines.push(
        "Respond with <span class=\"command\">answer 1</span>, <span class=\"command\">answer 2</span>, or <span class=\"command\">answer 3</span>."
      );
      return lines;
    },
  };
